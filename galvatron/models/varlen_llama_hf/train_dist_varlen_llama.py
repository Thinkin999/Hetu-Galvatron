...
def train(args):
    ...
    param_size_B = sum(p.numel() for p in gpt_model.parameters()) / 1024**3#GB
    if rank == 0:
        print(param_size_B)
    ...
    if args.use_flexSP:
        ...
        if args.model_size == 'gpt-7b' and world_size == 16:
            optimizer_param_dict[args.model_size]['act_per_token'] = 2.668764648#激活值大小
    ...
    trainloader = distributed_dataloader(#这个distributeeddloader很重要
