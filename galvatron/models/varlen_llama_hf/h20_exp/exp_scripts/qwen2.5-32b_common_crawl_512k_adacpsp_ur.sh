#!/bin/bash
# ============================================================
# Experiment: qwen2.5-32b_common_crawl_512k_adacpsp_ur
# Model: qwen2.5-32b | Seq: 512k | Strategy: adacpsp_ur | Dataset: common_crawl
# GBS: 256 | GPUs: 64 | Iters: 30
# ============================================================
set -o pipefail
...
EXP_NAME="qwen2.5-32b_common_crawl_512k_adacpsp_ur"
...
timeout 15m torchrun \
    ...
    --use-packing \
    --use-adaCPSP \
    --adaCPSP-attn-types ulysses ring \
