#!/bin/bash
# ============================================================
# Experiment: qwen2.5-7b_github_128k_adacpsp_full
# Model: qwen2.5-7b | Seq: 128k | Strategy: adacpsp_full | Dataset: github
...
EXP_NAME="qwen2.5-7b_github_128k_adacpsp_full"
