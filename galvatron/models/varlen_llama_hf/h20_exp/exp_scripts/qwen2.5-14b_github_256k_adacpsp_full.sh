#!/bin/bash
# ============================================================
# Experiment: qwen2.5-14b_github_256k_adacpsp_full
# Model: qwen2.5-14b | Seq: 256k | Strategy: adacpsp_full | Dataset: github
...
EXP_NAME="qwen2.5-14b_github_256k_adacpsp_full"
