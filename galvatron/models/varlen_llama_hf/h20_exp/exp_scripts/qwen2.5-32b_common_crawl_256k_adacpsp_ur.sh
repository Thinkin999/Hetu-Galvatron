#!/bin/bash
# ============================================================
# Experiment: qwen2.5-32b_common_crawl_256k_adacpsp_ur
# Model: qwen2.5-32b | Seq: 256k | Strategy: adacpsp_ur | Dataset: common_crawl
...
EXP_NAME="qwen2.5-32b_common_crawl_256k_adacpsp_ur"
