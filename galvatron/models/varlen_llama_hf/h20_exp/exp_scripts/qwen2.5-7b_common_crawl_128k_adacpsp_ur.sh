#!/bin/bash
# ============================================================
# Experiment: qwen2.5-7b_common_crawl_128k_adacpsp_ur
# Model: qwen2.5-7b | Seq: 128k | Strategy: adacpsp_ur | Dataset: common_crawl
...
EXP_NAME="qwen2.5-7b_common_crawl_128k_adacpsp_ur"
