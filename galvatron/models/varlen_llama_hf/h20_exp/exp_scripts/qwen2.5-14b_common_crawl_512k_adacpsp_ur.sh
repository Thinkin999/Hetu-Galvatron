#!/bin/bash
# ============================================================
# Experiment: qwen2.5-14b_common_crawl_512k_adacpsp_ur
# Model: qwen2.5-14b | Seq: 512k | Strategy: adacpsp_ur | Dataset: common_crawl
...
EXP_NAME="qwen2.5-14b_common_crawl_512k_adacpsp_ur"
