#!/bin/bash
# ============================================================
# Experiment: qwen2.5-14b_common_crawl_384k_adacpsp_full
# Model: qwen2.5-14b | Seq: 384k | Strategy: adacpsp_full | Dataset: common_crawl
...
EXP_NAME="qwen2.5-14b_common_crawl_384k_adacpsp_full"
