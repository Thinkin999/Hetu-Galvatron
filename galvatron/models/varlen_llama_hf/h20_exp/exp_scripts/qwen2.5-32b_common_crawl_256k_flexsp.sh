#!/bin/bash
# ============================================================
# Experiment: qwen2.5-32b_common_crawl_256k_flexsp
# Model: qwen2.5-32b | Seq: 256k | Strategy: flexsp | Dataset: common_crawl
...
EXP_NAME="qwen2.5-32b_common_crawl_256k_flexsp"
