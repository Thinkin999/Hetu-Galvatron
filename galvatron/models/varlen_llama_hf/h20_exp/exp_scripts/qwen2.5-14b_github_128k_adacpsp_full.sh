#!/bin/bash
# ============================================================
# Experiment: qwen2.5-14b_github_128k_adacpsp_full
# Model: qwen2.5-14b | Seq: 128k | Strategy: adacpsp_full | Dataset: github
...
EXP_NAME="qwen2.5-14b_github_128k_adacpsp_full"
