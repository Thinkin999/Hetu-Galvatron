#!/bin/bash
# ============================================================
# Experiment: qwen2.5-32b_github_384k_adacpsp_full
# Model: qwen2.5-32b | Seq: 384k | Strategy: adacpsp_full | Dataset: github
...
EXP_NAME="qwen2.5-32b_github_384k_adacpsp_full"
