#!/bin/bash
# ============================================================
# Experiment: qwen2.5-14b_common_crawl_384k_adacpsp_ur
# Model: qwen2.5-14b | Seq: 384k | Strategy: adacpsp_ur | Dataset: common_crawl
...
EXP_NAME="qwen2.5-14b_common_crawl_384k_adacpsp_ur"
