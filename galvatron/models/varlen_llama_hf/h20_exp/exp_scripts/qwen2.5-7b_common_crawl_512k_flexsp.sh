#!/bin/bash
# ============================================================
# Experiment: qwen2.5-7b_common_crawl_512k_flexsp
# Model: qwen2.5-7b | Seq: 512k | Strategy: flexsp | Dataset: common_crawl
...
EXP_NAME="qwen2.5-7b_common_crawl_512k_flexsp"
