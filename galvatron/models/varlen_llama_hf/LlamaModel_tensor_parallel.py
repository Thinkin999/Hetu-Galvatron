    ...
    def __init__(self, config, layer_number, tp_group=None, sp_group=None, cp_group=None):
        ...
        self.attention = SelfAttention(
            ...
            SelfAttentionSubmodules(
                ...
                core_attention=DotProductAttention,#when use_packing = True, we do not use this.
                flash_attention=FlashSelfAttentionVarlen,
                dist_attention=DistributedAttention,
                zigzag_ring_flash_attn=ZigzagRingFlashAttentionVarlen,
        ...
        # )
        #rope will be applied in the attention.py
    def forward(self, hidden_states, cu_seqlens, max_seqlen, attention_mask=None, rotary_embedding=None):
        input_tensor = hidden_states
        hidden_states = self.LayerNorm(hidden_states)
        hidden_states, bias = self.attention(hidden_states, cu_seqlens, max_seqlen, attention_mask, rotary_pos_emb=rotary_embedding)
